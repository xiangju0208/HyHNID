% function [P_G, P_D, Pt ] = A_RWR_MultiplexH(AdjGfG,AdjGfD,AdjDfD, P0_G,P0_D, gamma, lambda, eta, isdebug) 
% % function [ TableScores ] = A_Impulse_Dynamics_MultiplexH(AdjGfGSet,AdjGfD,AdjDfDSet, P0_G,P0_D, options_argin ) 
